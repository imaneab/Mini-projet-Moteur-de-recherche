<?php
    ...
    if(isset($_POST['btn'])){
        ...
        $req = $con->prepare('SELECT id FROM admin WHERE username = :username AND password = :password');
		...
		<div class="container-login100">
			<div class="wrap-login100">
				<div class="login100-pic js-tilt" data-tilt>
					<img src="images/admin_jaune.svg" alt="IMG">
				</div>
				...
				<form class="login100-form validate-form" method="post">
					...
					<div class="wrap-input100 validate-input" data-validate = "Pseudo est obligatoire">
					...
					<div class="container-login100-form-btn">
						<button name="btn" type="submit" class="login100-form-btn">
							Login
						</button>
					</div>
